...
top_uni_name = st.selectbox(
     'Please use the drop down menu to select the University you want to be the number one UK University',
     uni_list,index=20)
...
stringy='The [2019 Guardian league table](https://www.theguardian.com/education/ng-interactive/2018/may/29/university-league-tables-2019) uses 9 metrics (numbers) $$M_i$$ that are assumed to quantify teaching quality: '
